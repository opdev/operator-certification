...
// var _ preflight.Check = &FollowsRestrictedNetworkEnablementGuidelines{}

type FollowsRestrictedNetworkEnablementGuidelines struct{}

func (p FollowsRestrictedNetworkEnablementGuidelines) Validate(ctx context.Context, imgRef image.Reference) (bool, error) {
...
func (p FollowsRestrictedNetworkEnablementGuidelines) Metadata() types.Metadata {
...
func (p FollowsRestrictedNetworkEnablementGuidelines) Help() types.HelpText {
