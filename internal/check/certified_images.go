...
func (p *certifiedImagesCheck) Validate(ctx context.Context, imgRef image.Reference) (bool, error) {
...
func (p *certifiedImagesCheck) Metadata() types.Metadata {
...
func (p *certifiedImagesCheck) Help() types.HelpText {
