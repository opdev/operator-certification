...
// var _ preflight.Check = &securityContextConstraintsInCSV{}
...
func (p *securityContextConstraintsInCSV) Validate(ctx context.Context, bundleRef image.Reference) (bool, error) {
...
func (p *securityContextConstraintsInCSV) Metadata() types.Metadata {
...
func (p *securityContextConstraintsInCSV) Help() types.HelpText {
