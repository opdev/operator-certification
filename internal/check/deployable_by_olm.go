...
import (
	...
	"github.com/opdev/operator-certification/internal/log"
...
func (p *DeployableByOlmCheck) operatorMetadata(ctx context.Context, bundleRef image.Reference) (*operatorData, error) {
...
func (p *DeployableByOlmCheck) writeToFile(ctx context.Context, data interface{}) error {
	...
	// TODO: Re-enable when artifacts are figured out.
...
func (p *DeployableByOlmCheck) Help() types.HelpText {
